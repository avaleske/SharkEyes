...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Wave_Watch_Overlay.file'
        db.alter_column(u'pl_plot_wave_watch_overlay', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Wave_Watch_Overlay.file'
        db.alter_column(u'pl_plot_wave_watch_overlay', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

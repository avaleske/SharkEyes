...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pl_plot_wave_watch_overlay', (
            ...
            ('tile_dir', self.gf('django.db.models.fields.CharField')(max_length=240, null=True)),
            ('key', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True)),
            ('zoom_levels', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('is_tiled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))

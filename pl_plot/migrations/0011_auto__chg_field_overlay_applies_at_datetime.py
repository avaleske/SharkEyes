...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Overlay.applies_at_datetime'
        db.alter_column(u'pl_plot_overlay', 'applies_at_datetime', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Overlay.applies_at_datetime'
        db.alter_column(u'pl_plot_overlay', 'applies_at_datetime', self.gf('django.db.models.fields.DateTimeField')(default=''))
    ...
    models = {
        u'pl_plot.overlay': {
            ...
            'key_dir': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),

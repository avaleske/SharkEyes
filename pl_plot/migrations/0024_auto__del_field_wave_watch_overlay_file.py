...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Wave_Watch_Overlay.file'
        db.delete_column(u'pl_plot_wave_watch_overlay', 'file')


    def backwards(self, orm):
        # Adding field 'Wave_Watch_Overlay.file'
        db.add_column(u'pl_plot_wave_watch_overlay', 'file',

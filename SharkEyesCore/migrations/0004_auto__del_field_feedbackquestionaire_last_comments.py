...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeedbackQuestionaire.last_comments'
        db.delete_column(u'SharkEyesCore_feedbackquestionaire', 'last_comments')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FeedbackQuestionaire.last_comments'
        raise RuntimeError("Cannot reverse this migration. 'FeedbackQuestionaire.last_comments' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'FeedbackQuestionaire.last_comments'
        db.add_column(u'SharkEyesCore_feedbackquestionaire', 'last_comments',

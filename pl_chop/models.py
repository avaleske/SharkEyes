...
class TileManager():
    ...
    @staticmethod
    @shared_task(name='pl_chop.get_tile_next_few_das_group')
    def get_task_to_tile_next_few_days_of_untiled_overlays():
        overlay_ids_to_tile = OverlayManager.get_next_few_days_of_untiled_overlay_ids()
        return TileManager.get_tiling_task_by_ids(overlay_ids_to_tile)

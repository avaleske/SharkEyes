...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'se_pipeline_plotter_overlaydefinition', 'display_name')

        # Adding field 'OverlayDefinition.display_name_long'
        db.add_column(u'se_pipeline_plotter_overlaydefinition', 'display_name_long',
        ...
        db.add_column(u'se_pipeline_plotter_overlaydefinition', 'display_name_short',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'se_pipeline_plotter_overlaydefinition', 'display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64),
                      keep_default=False)

        # Deleting field 'OverlayDefinition.display_name_long'
        db.delete_column(u'se_pipeline_plotter_overlaydefinition', 'display_name_long')

        # Deleting field 'OverlayDefinition.display_name_short'
        db.delete_column(u'se_pipeline_plotter_overlaydefinition', 'display_name_short')
